class Evals
  ...
  def self.flash(distance=5); "$gamemode = 'direct_flash'; $message = \"Click the direction you would like to flash. '#{$key_mapping[:select_position]}' to choose coordinate.\"; false"; end
