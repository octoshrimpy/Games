(function() {
    ...
    (function() {
        ...
        Function.prototype.bind || (Function.prototype.bind = function(a) {
            ...
            var c = Array.prototype.slice.call(arguments, 1), d = this, e = function() {}, f = function() {
        ...
        this.addEventListener("removed", function(a) {
            if (null !== this.element.parentNode) {
                ...
                for (var c = 0, d = this.children.length; c < d; c++)
                    this.children[c].dispatchEvent(a)
            }
        })
    };
    ...
    ERNO.extend(String.prototype, {
        ...
        invert: function() {
            ...
            for (b = 0; b < this.length; b++)
                a = this.charAt(b) === this.charAt(b).toUpperCase() ? a + this.charAt(b).toLowerCase() : a + this.charAt(b).toUpperCase();
            return a
        },
        ...
        toUnicode: function() {
            var a, b, c = "";
            for (a = 0; a < this.length; a++) {
                for (b = this.charCodeAt(a).toString(16).toUpperCase(); 4 > b.length;)
                    b = "0" + b;
                c += "\\u" + b
            }
            return c
    ...
    ERNO.extend(Array.prototype, {
        ...
        toHtml: function() {
            var a, b = "<ul>";
            for (a = 0; a < this.length; a++)
                b = this[a]instanceof Array ? b + this[a].toHtml() : b + ("<li>" + this[a] + "</li>");
            return b + "</ul>"
        },
        toText: function(a) {
            var b, c, d;
            ...
            for (b =
            0; b < this.length; b++)
                d = this[b]instanceof Array ? d + (c + this[b].toText(a + 1)) : d + (c + this[b]);
            return d
        }
    });
    ...
    ERNO.Twist.validate = function() {
        ...
        for (c = 0; c < a.length; c++)
            ...
            if (1 === b.length)
                a[c] = "number" === typeof d ? new ERNO.Twist(b, d) : new ERNO.Twist(b);
            else {
                if (1 < b.length) {
                    d = /(-?\d+|[XLMRYUEDZFSB])/gi;
                    b = b.match(d);
                    for (f = 0; f < b.length; f++)
                        e = b[f], _.isNumeric(e) ? b[f] =+ e : (d = b.slice(0, f), h = b.slice(f + 1), e = e.split(""), b = d.concat(e, h));
                        d = a.slice(0, c);
                        h = a.slice(c + 1);
                        a = d.concat(b, h);
                        c--
                ...
                b instanceof ERNO.Direction ? a[c] = b.initial : b instanceof Array ? (d = a.slice(0, c), h = a.slice(c + 1), a = d.concat(b, h)) : a.splice(c, 1), c--;
        return a
    };
    ERNO.Cubelet = function(a, b, c) {
        ...
        this.faces = [];
        for (b = 0; 6 > b; b++)
            d = c[b] || ERNO.COLORLESS, this.faces[b] = {}, this.faces[b].id = b, this.faces[b].color =
    ...
    ERNO.extend(ERNO.Cubelet.prototype, {
        ...
        setRadius: function(a, b) {
            if (!1 === this.isTweening && (a = a || 0, void 0 === this.radius && (this.radius = 0), this.radius !== a)
                ...
                this.isTweening=!0;
                var c = (this.radius - a).absolute(), d = {
                    radius: this.radius
                };
    ...
    ERNO.extend(ERNO.Group.prototype, {
        ...
        remove: function(a) {
            ...
            for (var c = this.cubelets.length; 0 < c--;)
    ...
    ERNO.Slice = function(a, b) {
        ...
        this.rotateGroupMappingOnAxis = function() {
            ...
            return function(m) {
                ...
                for (q = 0; q < b.cubelets.length; q++)
                    b.cubelets[q].setAddress(q);
    ...
    ERNO.extend(ERNO.Slice.prototype, {
        ...
        get cubelets() {
            for (var a = [], b = this.indices.length; 0 < b--;)
    ...
    ERNO.Fold.prototype.setText = function(a) {
        ...
        a = a.justifyLeft(18);
        for (b = 0; 18 > b; b++)
            this.map[b].innerHTML = a.substr(b, 1)
    };
    ...
    ERNO.extend(ERNO.Cube.prototype, {
        shuffle: function(a, b) {
            ...
            for (this.historyQueue.empty(!0); 0 < a--;) {
                if (b)
                    ...
                    for (f = c.split(""), d = (new ERNO.Twist).copy(e); d.equals(e);)
        ...
        immediateTwist: function(a) {
            ...
            for (var b = this.slicesDictionary[a.command.toLowerCase()], c = (void 0 === a.degrees ? 90 : a.degrees) * a.vector, d = c.degreesToRadians(), e = Math.abs(d - b.rotation) / (0.5 * Math.PI) * this.twistDuration, f = b.indices.length, h; 0 < f--;)
        ...
        getText: function(a) {
            if (void 0 ===
            a)
                return [this.folds[0].getText(), this.folds[1].getText(), this.folds[2].getText()];
            if (_.isNumeric(a) && 0 <= a && 2 >= a)
                return this.folds[a].getText()
        },
    ...
    ERNO.Solver.prototype.consider = function(a) {
        if (void 0 === a)
            return console.warn("A cube [Cube] argument must be specified for Solver.consider()."), !1;
        if (!1 === a instanceof ERNO.Cube)
            return console.warn("The cube argument provided is not a valid Cube."), !1;
        a.isShuffling=!1;
